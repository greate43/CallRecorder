...
public final class DaggerAppComponent implements AppComponent {
  ...
  private Repository getRepository() {
    return RepositoryModule_ProvideRepositoryFactory.provideRepository(repositoryModule, context);}
  ...
  private void initialize(final RepositoryModule repositoryModuleParam,
    ...
    this.provideRepositoryProvider = RepositoryModule_ProvideRepositoryFactory.create(repositoryModuleParam, contextProvider);
  }
  ...
  private EditContactActivity injectEditContactActivity(EditContactActivity instance) {
    EditContactActivity_MembersInjector.injectRepository(instance, getRepository());
    return instance;
  }

  private RecorderService injectRecorderService(RecorderService instance) {
    RecorderService_MembersInjector.injectRepository(instance, getRepository());
    return instance;
  }
